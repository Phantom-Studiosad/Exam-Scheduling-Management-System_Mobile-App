...
import 'package:exam_schedule/src/Widget/loginscreen/Student_Home.dart';
import '../../../Student.dart';
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        _detail(),
                        SizedBox(height: 35,),
                        Text("                        ALL THE BEST🤞", style: TextStyle(fontSize: 20,color: Colors.deepOrange,fontWeight: FontWeight.bold), textAlign: TextAlign.center,),
                        SizedBox(height: 25,),
                        _edetail(),
                        SizedBox(height: 10,),
                        _edetail1(),
