...
import 'Widget/loginscreen/Admin_Home.dart';
...
class _AdminState extends State<Admin> {
  ...
  void logIn() {
    FirebaseAuth.instance.signInWithEmailAndPassword(
      ...
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => AHomeScreen(signOut),),
  ...
  Widget _emailbutton() {
    return InkWell(
      onTap: () {
        Navigator.of(context).pop();
        if(_email.text.contains("@cb.admin.amrita.edu")){
          forgot();
        }
        else{
          showDialog(
              ...
              builder: (BuildContext context) {
                return AlertDialog(
                  ...
                  content: Text("You are not authorised to change password in admin page!!!"),
                  actions: [
                    FlatButton(
                      child: Text("Ok"),
                      onPressed: () {
                                            ...
                                            SigninButton(
                                                ...
                                                onPressed: () {
                                                  if (_formKey.currentState.validate()) {
                                                    if(_emailController.contains("@cb.admin.amrita.edu")){
                                                      logIn();
                                                    }
                                                    else{
                                                      showDialog(
                                                          ...
                                                          builder: (BuildContext context) {
                                                            return AlertDialog(
                                                              title: Text("NOT AUTHORISED"),
                                                              content: Text("You are not authorised to login through admin page!!!"),
                                                              actions: [
                                                                FlatButton(
                                                                  child: Text("Ok"),
                                                                  onPressed: () {
                              ...
                              GestureDetector(
                                  onTap: () async {
                                    ...
                                    if (weCanCheckBiometrics) {
                                      bool authenticated = await localAuth
                                      ...
                                      if (authenticated) {
                                        Navigator.push(
                                          context,
                                          MaterialPageRoute(
                                            builder: (context) => AHomeScreen(signOut),
                                          ),
                                        );
                                      }
                                    }
